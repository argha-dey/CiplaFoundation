...
public class SlideHolder extends FrameLayout {
    ...
    /**
     *
     * direction - direction in which SlideHolder opens. Can be: DIRECTION_LEFT, DIRECTION_RIGHT
     */
    ...
    /**
     *
     * allow - if false, SlideHolder won't react to swiping gestures
     */
    ...
    /**
     *
     * opened - if true, SlideHolder will always be in opened state.
     */
    ...
    public boolean open() {
       ...
       initSlideMode(); // close initSlide for Slide on touch

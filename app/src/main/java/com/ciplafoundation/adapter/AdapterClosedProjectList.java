...
public class AdapterClosedProjectList extends RecyclerView.Adapter<AdapterClosedProjectList.MyViewHolder>  {
    private Context mContext;
    private ArrayList<PendingProposal> closedProjectList=new ArrayList<>();
    private UserClass user=new UserClass();
    private VolleyTaskManager volleyTaskManager;
    private boolean isProposalDetails=false;
    private Prefs prefs;
    private RecyclerView rcl;
    public AdapterClosedProjectList(Context _mContext,RecyclerView rcv) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_header.setText(closedProjectList.get(position).getTitle());
        ...
        holder.rl_header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (holder.rl_child.isShown()) {
                    ...
                    String timeline=closedProjectList.get(position).getTime_line_date();
                    builder_timeline.append(timeline);
                    String duration = " ( "+closedProjectList.get(position).getTime_line_duration()+" )";
                ...
                /*    holder.tv_budget_data_view.setText(
                    ...
                    if(!closedProjectList.get(position).getBudget().isEmpty())
                        holder.tv_budget_data_view.setText(new DecimalFormat("##,##,##0").format(Integer.parseInt(closedProjectList.get(position).getBudget())));

                    SpannableStringBuilder builder_createdBy = new SpannableStringBuilder();
                    String CreatedBy="By "+closedProjectList.get(position).getCreated_by()+" on " ;
                    builder_createdBy.append(CreatedBy);
                    String created_date=closedProjectList.get(position).getCreated_date();
                    ...
                    String NGO_type=closedProjectList.get(position).getNgo_type();
                    if(NGO_type.equalsIgnoreCase("NGO"))
                    {
                        holder.tv_implemented_by_NGO_data_view.setText("NGO");
                        holder.tv_implemented_by_data_view.setText(closedProjectList.get(position).getNgo());
                        String str=closedProjectList.get(position).getNgo();
                    ...
                    {
                        holder.tv_implemented_by_NGO_data_view.setText(closedProjectList.get(position).getNgo_type());
        ...
        holder.ib_btn_pending_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Util.checkConnectivity(mContext))
                {
                    ...
                    String id=closedProjectList.get(position).getId();
    ...
    public void AddArray(ArrayList<PendingProposal> _arrDataFormListItems) {
        ...
        if (_arrDataFormListItems != null
            ...
            closedProjectList.addAll(_arrDataFormListItems);
        }
